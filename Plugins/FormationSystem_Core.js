...
Game_Battler.prototype.isVanguard = function() {
    return this.friendsUnit().aliveVanguardMembers().contains(this);
};

Game_Battler.prototype.isRearguard = function() {
    return this.friendsUnit().aliveRearguardMembers().contains(this);
};
...
var __Game_Unit_initialize = Game_Unit.prototype.initialize;
Game_Unit.prototype.initialize = function() {
    __Game_Unit_initialize.call(this);
...
var __Game_Unit_aliveMembers = Game_Unit.prototype.aliveMembers;
Game_Unit.prototype.aliveFormationMembers = function() {
    return __Game_Unit_aliveMembers.call(this).sort((a, b)=>{
...
var __Game_Unit_deadMembers = Game_Unit.prototype.deadMembers;
Game_Unit.prototype.deadFormationMembers = function() {
    return __Game_Unit_deadMembers.call(this).sort((a, b)=>{
        return a.formationSlotIndex() - b.formationSlotIndex();
    });
};
...
var __Game_Unit_isMemberAddableToSlot = Game_Unit.prototype.isMemberAddableToSlot;
Game_Party.prototype.isMemberAddableToSlot = function(member, slotId) {
    return __Game_Unit_isMemberAddableToSlot.call(this, member, slotId) && this.existingFormationMembers().length < this.battleMembers().length;
};

var __Game_Party_setupStartingMembers = Game_Party.prototype.setupStartingMembers;
Game_Party.prototype.setupStartingMembers = function() {
    __Game_Party_setupStartingMembers.call(this);
...
var __Game_Party_addActor = Game_Party.prototype.addActor;
Game_Party.prototype.addActor = function(actorId) {
    __Game_Party_addActor.call(this, actorId);
    if(!this._actors.contains(actorId)) {
        this.updateAddFormationSlots($gameActors.actor(actorId));
    }
};

var __Game_Party_removeActor = Game_Party.prototype.removeActor;
Game_Party.prototype.removeActor = function(actorId) {
    __Game_Party_removeActor.call(this, actorId);
    if(this._actors.contains(actorId)) {
        this.updateRemoveFormationSlots($gameActors.actor(actorId));
    }
};

var __Game_Party_swapOrder = Game_Party.prototype.swapOrder;
Game_Party.prototype.swapOrder = function(index1, index2) {
    __Game_Party_swapOrder.call(this);
...
var __Game_Troop_onBattleEnd = Game_Unit.prototype.onBattleEnd;
Game_Troop.prototype.onBattleEnd = function() {
    __Game_Troop_onBattleEnd.call(this);
    this.refreshFormationSlots();
};

var __Game_Troop_setup = Game_Troop.prototype.setup;
Game_Troop.prototype.setup = function(troopId) {
    __Game_Troop_setup.call(this, troopId);
...
var __Game_Action_targetsForOpponents = Game_Action.prototype.targetsForOpponents;
Game_Action.prototype.targetsForOpponents = function() {
    ...
    if(this.isForFormationMembers()) {
        ...
        targets = __Game_Action_targetsForOpponents.call(this);
        unit.setFormationTargetType('');
        return targets;
    } else {
        return __Game_Action_targetsForOpponents.call(this);
    }
};

var __Game_Action_targetsForFriends = Game_Action.prototype.targetsForFriends;
...
var __Sprite_Actor_setActorHome = Sprite_Actor.prototype.setActorHome;
Sprite_Actor.prototype.setActorHome = function(index) {
    __Sprite_Actor_setActorHome.call(this, index);
...
Sprite_Enemy.prototype.setBattler = function(battler) {
    __Sprite_Enemy_setBattler.call(this, battler);
...
var __Scene_Battle_selectEnemySelection = Scene_Battle.prototype.selectEnemySelection;
Scene_Battle.prototype.selectEnemySelection = function() {
    var action = BattleManager.inputtingAction();
    var unit = action.isForFriend() ? $gameParty : $gameTroop;
    if(action.isForRearguard()) {
        unit.setFormationTargetType('rearguard');
    } else if(action.isForAllFormationMembers()) {
        unit.setFormationTargetType('all');
    }
    __Scene_Battle_selectEnemySelection.call(this);
    unit.setFormationTargetType('');
};
