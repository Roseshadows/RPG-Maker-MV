...
//=========================================================
/*:
 * @plugindesc ver2.10 - 简易可滚动信息板 (读报系统)
 ...
 * ver1.00 - 完成。
 * ver2.00 - 增加了对RMMZ的支持。
 * ver2.10 - 新增功能，可以根据文本滚动速度设定背景样式为窗口或是透明。
 * 
...
Window_ScrollText.prototype.refreshWindowType = function() {
    if($gameSwitches.value(RSSD.SimpleScrollableInfoBoard.switchId)) {
        ...
        } else if($gameMessage.scrollSpeed() == 1) {
            this.opacity = 0;
            this.openness = 255;
            this.width = this.windowWidth();
            this.height = this.windowHeight();
...
if(Utils.RPGMAKER_NAME == 'MZ') {
    var __Window_ScrollText_updatePlacement = Window_ScrollText.prototype.updatePlacement;
    Window_ScrollText.prototype.updatePlacement = function() {
        if($gameSwitches.value(RSSD.SimpleScrollableInfoBoard.switchId)) {
            ...
            __Window_ScrollText_updatePlacement.call(this);
        }
    }
}
