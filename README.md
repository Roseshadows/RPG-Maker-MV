...
- 💞️ 有个分支里存放着一些（可能就几个）我自己写的很菜很冗长的插件和一些修改他人插件过后的产物（被修改的插件均遵循MIT协议），以及意义不明的代码。随便去用就好，署不署名随意。（具体的使用条款可以在插件中找到）（好家伙，说得好像真的有人愿意用似的）
...
- There are also some plugins modified by me, which belongs to others. According to their owners, most of these plugins are released under MIT License.
